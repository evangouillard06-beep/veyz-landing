...
export default function AuroraBackground() {
  return (
    ...
    >
      ...
      <div className="absolute top-24 left-[-12%] h-[300px] w-[300px] rounded-full bg-emerald-500/10 blur-[80px] [animation-delay:-6s] motion-safe:md:animate-aurora-drift md:h-[420px] md:w-[420px] md:blur-[120px]" />
